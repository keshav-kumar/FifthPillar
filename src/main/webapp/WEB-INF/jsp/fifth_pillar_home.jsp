...
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
<div class="wrapper bgded overlay" style="background-image:url('images/homePage.png');">
  <div id="pageintro" class="hoc clear"> 
    <!-- ################################################################################################ -->
    <article>
      <h2 class="heading">Fifth Pillar</h2>
      <p>An initiative by <a href="/worldofhonesty/home">The World of Honesty</a></p>
  ...
  <main class="hoc container clear"> 
    ...
    <div class="group btmspace-80">
      <div class="fl_left">
        ...
        <img class="imgl borderedbox inspace-5" src="/images/Home/The World of Honesty.png" alt="">
        <p>A registered non-governmental organization whose purpose is social welfare. All trustees of this organization have to give honesty test by a lie detector (polygraph) on regular interval. The trustee's membership is canceled if it is failed in this test.</p>
      </div>
    </div>
    ...
    <div class="group btmspace-80">
      <div class="fl_left">
        <h4>Execution</h4>
        <img class="imgr borderedbox inspace-5" src="/images/Home/Execution.jpg" alt="">
