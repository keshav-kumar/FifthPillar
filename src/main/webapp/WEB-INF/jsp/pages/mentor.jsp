...
<html>
<head>
<title>Fifth Pillar | Mentors Page</title>
<meta charset="utf-8">
...
<div class="wrapper row1">
  <header id="header" class="hoc clear"> 
    ...
    <div id="logo" class="fl_left">
      <h1><a href="/home">Fifth Pillar</a> / <a href="/mentor">Mentor</a></h1>
    </div>
      ...
      <ul class="clear">
        ...
        <li class="active"><a class="drop" href="#">Pages</a>
          <ul>
            ...
            <li class="active"><a href="/mentor">Mentor</a></li>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      ...
      <img class="imgr borderedbox inspace-5" src="../images/demo/im.gif" alt="">
      ...
      <h1>Expectation</h1>
      <img class="imgl borderedbox inspace-5" src="../images/demo/expectation.gif" alt="">
      ...
      <h1>Benefit</h1>
      <img class="imgr borderedbox inspace-5" src="../images/demo/expectation.gif" alt="">
